...
public class EFragment extends BaseListFragment implements BaseLoadMoreAdapter.OnLoadMoreCallback, RequestTask.OnTaskListener, SisterViewHolder.OnHolderClickListener {

    private EFragment me = this;
    private int mPage = 1;
    ...
    protected void loadData(boolean loadFirstPage) {
        ...
        new RequestTask(me).execute(RequestFactory.getJokeFromSister(SisterType.TYPE_DUANZI, mPage));
    }
